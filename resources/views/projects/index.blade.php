        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-duration="3000">
                <div class="single_blog_item_area blog_grid_item para_default image_fulwidth text-left">
                    <a href="{{ route('projects.show',$p->slug) }}"><img
                            src="{{Voyager::image($p->thumbnail('cropped'))}}" alt="images"></a>
                    <h3><a href="{{ route('projects.show',$p->slug) }}">{{ $p->title }}</a></h3>
                    <p class="text-left">{!! Str::limit($p->body,70) !!} <a
                            href="{{ route('projects.show',$p->slug) }}">Read More <i class="fa fa-chevron-right"
